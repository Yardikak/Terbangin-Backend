<x-app-layout>
    <div class="max-w-2xl mx-auto p-6 bg-white shadow-md rounded-md mt-10">
        <h1 class="text-2xl font-bold mb-6">Add New Promo</h1>
        ...
        <form method="POST" action="{{ route('promo.store') }}">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="promo_code" name="promo_code" value="{{ old('promo_code') }}" required
            ...
            <button type="submit" class="btn btn-primary mt-4">Save Promo</button>
        </form>
    </div>
</x-app-layout>
