    ...
    <div class="max-w-2xl mx-auto p-6 bg-white shadow-md rounded-md mt-10">
        ...
        <form method="POST" action="{{ route('flights.update', $flight->flight_id) }}">
            ...
            <div class="mb-4">
                ...
                <input type="datetime-local" id="departure" name="departure" value="{{ old('departure', $flight->departure) }}" required
                       class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="datetime-local" id="arrival" name="arrival" value="{{ old('arrival', $flight->arrival) }}" required
                       class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
            </div>
